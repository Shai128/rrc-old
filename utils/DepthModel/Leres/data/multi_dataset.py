...
from helper import get_current_seed, set_seeds
from utils.I2IRegressionUQModel import get_feature_points_mask
...
class MultiDataset(Dataset):
    ...
    def __getitem__(self, index):
        return self.get_item(index, apply_augmentation=True)
    ...
    def get_data(self, index, apply_augmentation):
        ...
        data['rgb'] = data['rgb']  # .permute(1, 2, 0)
    ...
    def set_flip_resize_crop_pad(self, A, flip = True, random_resize = True):
        ...
        if 'train' in self.opt.phase and random_resize:
